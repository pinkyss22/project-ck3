			...
			<form action = 'up-san-pham-submit.php' method= 'post' enctype="multipart/form-data">
					...
					<?php
						if($dem==3)
						{
							...
							mysqli_query ($con1, "INSERT INTO san_pham (Ten_san_pham, Gia_ban, Hinh_dai_dien, Ma_danh_muc, Dac_ta, Ma_tinh_trang, So_luong_ton, So_luong_ban, So_luot_xem, Ma_nguoi_ban) VALUE('$_POST[ten_san_pham]', '$_POST[gia_ban]', 'image/$hinh_anh','$_POST[danh_muc]', '$_POST[thong_tin]', '1', '$_POST[so_luong]', '0', '0', '$ma_nguoi_ban')");
